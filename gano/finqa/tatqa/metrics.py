...
from gano.finqa.tatqa.tagop.utils import is_number, normalize_answer, scale_to_num, to_number

LOSS_KEYS = ('loss', 'loss_tbl', 'loss_prg', 'loss_opr', 'loss_order', 'loss_scale', 'top2_len')
METRIC_KEYS = ('em', 'f1', 'scale', 'opr')
