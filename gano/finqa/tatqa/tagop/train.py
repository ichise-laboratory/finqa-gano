...
from gano.finqa.tatqa.train import TatQATrainerForLM


class TagOpTrainer(TagOpExperiment, TatQATrainerForLM):
    def add_args(self, defaults: dict = None) -> None:
        ...
        add('--dropout', type=float, default=None, help='Dropout probability')
